...
inner join tbl_vehicule on tbl_vehicule.id_vehicule=tbl_souscription.id_vehicule where tbl_souscription.etat=1 ");
...
?>
 ...
 <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Liste des Souscriptions Validées</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                                    ...
                                                    <td><?=$row['montant']?></td>
                                                    <td><?=$row['periode']?></td>
                                                    <td> <?php if($row['etat']==1) echo "Déjà validée"?></td>
                                                    <td>
